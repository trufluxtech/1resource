# Mac Run Guide — 1Resource v1.0.18

## Start

```bash
cd truflux_resume_portal_v1.0.18_mac_venv_fix
...
```bash
cd truflux_resume_portal_v1.0.18_mac_venv_fix/frontend
...
## v1.0.18 Mac Virtual Environment Fix
