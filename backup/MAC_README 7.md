# Mac Run Guide — 1Resource v1.0.21

## Start

```bash
cd truflux_resume_portal_v1.0.21_mac_venv_fix
...
```bash
cd truflux_resume_portal_v1.0.21_mac_venv_fix/frontend
...
## v1.0.21 Mac Virtual Environment Fix
