# Mac Run Guide — 1Resource v1.0.20

## Start

```bash
cd truflux_resume_portal_v1.0.20_mac_venv_fix
...
```bash
cd truflux_resume_portal_v1.0.20_mac_venv_fix/frontend
...
## v1.0.20 Mac Virtual Environment Fix
